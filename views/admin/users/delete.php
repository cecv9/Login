...
<div class="admin-container">
    ...
    <?php if ($user): ?>  <!-- Asume $user de controller; si null, redirect ya hecho -->
        <div class="confirmation-box">  <!-- UX: Muestra info antes de borrar -->
            ...
            <p class="warning">Esto es un borrado suave (puede recuperarse si se implementa). No afecta datos relacionados.</p><style>  <!-- CSS inline temporal si admin.css no tiene; mueve a CSS después -->
